...
MODEL                = Foc_model_Matlab_ultimo
MODULES              = Foc_model_Matlab_ultimo_data.c freemaster_interface_init.c ftm2_ch1_hall_sensor_isr.c ftm2_input_params_config.c ftm3_pwm_params.c mbd_main.c pdb0_params.c pdb1_params.c profile_buffer.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rtmodel.c tpp_ic_init.c adc_driver.c clock_S32K1xx.c edma_driver.c edma_hw_access.c edma_irq.c freemaster_S32K1xx.c freemaster_appcmd.c freemaster_protocol.c freemaster_rec.c freemaster_scope.c freemaster_serial.c freemaster_sfio.c freemaster_tsa.c ftm_chn_irq.c ftm_common.c ftm_fault_irq.c ftm_hw_access.c ftm_ic_driver.c ftm_mc_driver.c ftm_oc_driver.c ftm_pwm_driver.c ftm_qd_driver.c gpio_irq.c gt_pf.c interrupt_manager.c lin_common.c lin_driver.c lin_irq.c lin_lpuart_driver.c lpit_driver.c lpspi_hw_access.c lpspi_irq.c lpspi_master_driver.c lpspi_shared_function.c lpspi_slave_driver.c lpuart_driver.c lpuart_hw_access.c lpuart_irq.c mbd_adc_irq.c osif_baremetal.c pdb_driver.c pdb_hw_access.c pins_driver.c pins_port_hw_access.c power_manager.c power_manager_S32K1xx.c power_smc_hw_access.c s32k_clock_init.c spi_aml.c startup.c system_S32K144.c tpp.c trgmux_driver.c trgmux_hw_access.c wait_aml.c
MAKEFILE             = Foc_model_Matlab_ultimo.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2024b
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2024b
START_DIR            = C:\Users\diego\Documents\GitHub\Personale\Progetto_di_tirocinio\Modello_FOC_originale
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 4
...
#--------------------------- GCC -----------------------
GCC_TARGET_CC_OPTS      = -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O1 -g -gstrict-dwarf -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
GCC_TARGET_ASM_OPTS     = -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -g -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
GCC_TARGET_LINK_OPTS    = -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
GCC_TARGET_LIB_OPTS     = 
#--------------------------- GHS -----------------------
GHS_TARGET_CC_OPTS      = -cpu=cortexm4f -thumb -DARM_MATH_CM4 -fpu=vfpv4_d16 -fsingle -Ogeneral -Wundef -Wimplicit-int -Wshadow -Wtrigraphs --no_commons --gnu_asm -gnu99 -gdwarf-2 -G -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\Foc_model_Matlab_ultimo_mbd_rtw \
...
###################################
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\reg/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\reg\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\gpio/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\gpio\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\ftm/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\ftm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\fm/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\fm\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\profiler/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\profiler\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\adc/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\adc\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\pdb/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\pdb\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\lpspi/%.c
	@echo ### "C:\Users\diego\AppData\Roaming\MATHWO~1\MATLAB~1\TOOLBO~1\NXP_MB~2\MBDTBX~1\blocks\lpspi\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
...
%.o : $(MATLAB_ROOT)\toolbox\simulink\blocks\src/%.c
	@echo ### "$(MATLAB_ROOT)\toolbox\simulink\blocks\src\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
