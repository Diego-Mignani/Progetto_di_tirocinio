...
void Foc_model_Matlab_ultimo_step(int_T tid)
{
  switch (tid) {
   case 0 :
    Foc_model_Matlab_ultimo_step0();
    break;

   case 1 :
    Foc_model_Matlab_ultimo_step1();
    break;

   case 2 :
    Foc_model_Matlab_ultimo_step2();
    break;

   case 3 :
    Foc_model_Matlab_ultimo_step3();
    break;
