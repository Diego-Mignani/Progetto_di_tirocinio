...
void FTM2_Ch1_Hall_Sensor_isr(void)
{
  ...
  /* Output and update for function-call system: '<Root>/Hall Sensor' */
  {
    ...
    Foc_model_Matlab_3_B.Digital_Input_HALL_A_b = (PINS_DRV_ReadPins(PTA) >> 1)
      & 0x01;
    ...
    /* '<S191>:1:6' */
    HALL_A = (uint32_T)Foc_model_Matlab_3_B.Digital_Input_HALL_A_b << 2;
    ...
    Foc_model_Matlab_3_B.Digital_Input_HALL_B_l = (PINS_DRV_ReadPins(PTD) >> 10)
      & 0x01;
    ...
    /* '<S192>:1:6' */
    HALL_B = (uint32_T)Foc_model_Matlab_3_B.Digital_Input_HALL_B_l << 1;
    ...
    Foc_model_Matlab_3_B.Digital_Input_HALL_C_h = (PINS_DRV_ReadPins(PTD) >> 11)
      & 0x01;

    /* DataTypeConversion: '<S187>/Data Type Conversion6' */
    HALL_C = (uint32_T)Foc_model_Matlab_3_B.Digital_Input_HALL_C_h;
     ...
     case 2:
      ...
      switch (rtb_Add1) {
       ...
       case 4:
         ...
         */
        Foc_model_Matlab_3_B.Merge_m = 6U;

        /* Merge: '<S195>/Merge1' incorporates:
         *  Constant: '<S197>/next'
         *  SignalConversion generated from: '<S197>/Out2'
         */
        Foc_model_Matlab_3_B.Merge1 = 5U;
       ...
       case 5:
         ...
         */
        Foc_model_Matlab_3_B.Merge_m = 4U;

        /* Merge: '<S195>/Merge1' incorporates:
         *  Constant: '<S198>/next'
         *  SignalConversion generated from: '<S198>/Out2'
         */
        Foc_model_Matlab_3_B.Merge1 = 1U;
       ...
       case 1:
         ...
         */
        Foc_model_Matlab_3_B.Merge_m = 5U;

        /* Merge: '<S195>/Merge1' incorporates:
         *  Constant: '<S199>/next'
         *  SignalConversion generated from: '<S199>/Out2'
         */
        Foc_model_Matlab_3_B.Merge1 = 3U;
       ...
       case 3:
         ...
         */
        Foc_model_Matlab_3_B.Merge_m = 1U;

        /* Merge: '<S195>/Merge1' incorporates:
         *  Constant: '<S200>/next'
         *  SignalConversion generated from: '<S200>/Out2'
         */
        Foc_model_Matlab_3_B.Merge1 = 2U;
       ...
       case 2:
         ...
         */
        Foc_model_Matlab_3_B.Merge_m = 3U;

        /* Merge: '<S195>/Merge1' incorporates:
         *  Constant: '<S201>/next'
         *  SignalConversion generated from: '<S201>/Out2'
         */
        Foc_model_Matlab_3_B.Merge1 = 6U;
       ...
       */
      if ((uint16_T)GlobalHallState == Foc_model_Matlab_3_B.Merge_m) {
      ...
      } else if ((uint16_T)GlobalHallState == Foc_model_Matlab_3_B.Merge1) {
      ...
      rtb_Merge1 = Foc_model_Matlab_3_B.Merge2;
      ...
      if (HallValididyInvalid != 0) {
        ...
        rtb_Merge3 = (Foc_model_Matlab_3_B.Merge2 == GlobalDirection);
      }
